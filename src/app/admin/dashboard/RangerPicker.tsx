    ...
    <div className="rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
      <div className="flex flex-wrap items-end gap-3">
        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Da</label>
          <input
            type="date"
            value={startISO}
        ...
        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">A</label>
          <input
            type="date"
            value={endISO}
        ...
        <div className="hidden h-10 w-px bg-neutral-200 dark:bg-neutral-800 sm:block" />

        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Mese</label>
          <input
            type="month"
            value={monthValue}
        ...
        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Anno</label>
          <select
            value={String(year)}
        ...
        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Trimestre</label>
          <select
            value={quarter}
        ...
        <div className="flex flex-col">
          <label className="text-xs font-semibold text-neutral-500 dark:text-neutral-400">Semestre</label>
          <select
            value={semester}
