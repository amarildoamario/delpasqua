...
export default function ShipWithTracking({
  ...
  return (
    <div className="rounded-2xl bg-neutral-50 p-3 ring-1 ring-neutral-200/60 dark:bg-neutral-950/40 dark:ring-neutral-800/60">
      ...
      {status === "PREPARING" ? (
        <div className="mt-2">
          ...
          <input
            ...
            className="mt-1 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-xs text-neutral-900 outline-none focus:ring-2 focus:ring-neutral-900/10 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-100 dark:focus:ring-white/10"
            disabled={loading}
          />
        </div>
      ) : null}
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <button
          ...
          className={[
            ...
            "border border-neutral-200/70 bg-white text-neutral-900 hover:bg-neutral-50 dark:border-neutral-800/70 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800",
