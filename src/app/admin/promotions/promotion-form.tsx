    ...
    >
      <span
        className={[
          ...
          on ? "left-7 bg-white dark:bg-neutral-900" : "left-1 bg-neutral-200 dark:bg-neutral-700",
        ].join(" ")}
      />
    </button>
  );
...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-[11px] font-bold uppercase tracking-wide text-neutral-500 dark:text-neutral-400">
      {children}
    </div>
  );
}
  ...
  return (
    <input
      ...
      className={[
        ...
        "dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-100 dark:focus:ring-neutral-800",
        props.className || "",
      ].join(" ")}
    />
  );
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between rounded-2xl border border-neutral-200 bg-neutral-50 px-4 py-3 dark:border-neutral-800 dark:bg-neutral-950">
            <div>
              <div className="text-sm font-extrabold text-neutral-900 dark:text-neutral-100">
                Spedizione gratis
              </div>
              <div className="text-xs text-neutral-500 dark:text-neutral-400">Forza shipping a 0</div>
            </div>
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950">
            <div className="flex items-end justify-between gap-3">
              <div>
                ...
                <div className="mt-1 text-sm font-semibold text-neutral-600 dark:text-neutral-300">
                  Range date (opzionale)
                </div>
              </div>
              <div className="text-xs font-semibold text-neutral-400">
                Tipo: <span className="text-neutral-600 dark:text-neutral-300">{inferredType}</span>
              </div>
            </div>

            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div>
                <div className="text-xs font-bold text-neutral-500 dark:text-neutral-400">Inizio</div>
                <Input
                  type="datetime-local"
              ...
              <div>
                <div className="text-xs font-bold text-neutral-500 dark:text-neutral-400">Fine</div>
                <Input
                  type="datetime-local"
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950">
            ...
            <div className="mt-1 text-sm font-semibold text-neutral-600 dark:text-neutral-300">{percent}%</div>
            <input
              type="range"
              min={0}
              max={100}
          ...
          <div>
            ...
            />
            <div className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">Lascia 0 se non ti serve.</div>
          </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <button
          type="submit"
          disabled={loading}
          className="rounded-2xl bg-neutral-900 px-5 py-3 text-sm font-extrabold text-white shadow-sm hover:opacity-90 disabled:opacity-60 dark:bg-white dark:text-neutral-900"
        >
          {loading ? "Salvataggio..." : "Crea codice"}
        </button>

        {msg && (
          <div className="rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm font-semibold text-neutral-700 dark:border-neutral-800 dark:bg-neutral-900 dark:text-neutral-200">
            {msg}
          </div>
        )}
      </div>
