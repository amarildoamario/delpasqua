  ...
  return (
    <button
      ...
      className={[
        ...
        shipped
          ? "border border-neutral-200/70 bg-white text-neutral-900 hover:bg-neutral-50 disabled:hover:bg-white dark:border-neutral-800/70 dark:bg-neutral-900 dark:text-neutral-100 dark:hover:bg-neutral-800 dark:disabled:hover:bg-neutral-900"
          : "bg-neutral-900 text-white hover:opacity-90 disabled:hover:opacity-60 dark:bg-white dark:text-neutral-900",
