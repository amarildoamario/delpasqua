  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-white text-black dark:bg-black dark:text-white">
      <div className="pointer-events-none absolute inset-0 -z-10">
        {/* light */}
        <div className="absolute -top-56 left-[-220px] hidden h-[720px] w-[720px] rounded-full bg-black/5 blur-3xl sm:block dark:hidden" />
        <div className="absolute -bottom-60 right-[-220px] hidden h-[720px] w-[720px] rounded-full bg-black/4 blur-3xl sm:block dark:hidden" />
        ...
        {/* dark */}
        <div className="absolute -top-56 left-[-220px] hidden h-[720px] w-[720px] rounded-full bg-white/10 blur-3xl sm:block dark:block" />
        <div className="absolute -bottom-60 right-[-220px] hidden h-[720px] w-[720px] rounded-full bg-white/5 blur-3xl sm:block dark:block" />
