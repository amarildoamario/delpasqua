  ...
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-white text-black dark:bg-black dark:text-white">
      <div className="pointer-events-none absolute inset-0 -z-10">
        {/* light */}
        <div className="absolute -top-56 right-[-220px] hidden h-[720px] w-[720px] rounded-full bg-black/5 blur-3xl sm:block dark:hidden" />
        <div className="absolute -bottom-60 left-1/2 hidden h-[720px] w-[720px] -translate-x-1/2 rounded-full bg-black/4 blur-3xl sm:block dark:hidden" />
        ...
        {/* dark */}
        <div className="absolute -top-56 right-[-220px] hidden h-[720px] w-[720px] rounded-full bg-white/10 blur-3xl sm:block dark:block" />
        <div className="absolute -bottom-60 left-1/2 hidden h-[720px] w-[720px] -translate-x-1/2 rounded-full bg-white/5 blur-3xl sm:block dark:block" />
      ...
      <section className="flex flex-1 items-center">
        <div className="mx-auto w-full max-w-6xl px-6 py-16 sm:py-24">
          ...
          <details className="mt-12 max-w-2xl">
            <summary className="cursor-pointer text-sm font-semibold text-black/50 transition hover:text-black/70 dark:text-white/60 dark:hover:text-white/80">
              Dettagli tecnici (dev)
            </summary>
            <pre className="mt-4 overflow-auto rounded-2xl border border-black/10 bg-black/[0.03] p-4 text-xs text-black/70 dark:border-white/10 dark:bg-white/5 dark:text-white/70">
