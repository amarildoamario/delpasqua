  ...
  return (
    <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4">
      ...
      <input
        ...
        className="mt-3 w-full rounded-xl border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-900"
      />
      <div className="mt-2 text-[11px] text-neutral-500">Key: {k}</div>
    </div>
  );
}
...
export default function SettingsForm({ initial }: { initial: SettingsMap }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-3xl border border-neutral-200 bg-white p-5 shadow-sm">
        <div className="text-sm font-semibold text-neutral-900">Chiavi custom</div>
