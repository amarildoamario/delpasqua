...
async function OlioBiologicoPage({ params }: { params: Promise<{ locale: string }> }) {
...
export default async function OlioBiologicoPageWrapper(props: any) {
  const { locale } = await props.params;
  setRequestLocale(locale);
  return <OlioBiologicoPage {...props} />;
}
