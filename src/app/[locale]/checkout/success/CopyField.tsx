  ...
  return (
    <div className="rounded-2xl border border-black/10 bg-white/70 p-3 backdrop-blur">
      <div className="mb-2 flex items-center justify-between gap-3">
        <div className="text-[11px] tracking-[0.08em] text-gray-600">
          {label.toUpperCase()}
        </div>
      ...
      <input
        ...
        readOnly
        value={value}
        className="w-full rounded-xl border border-black/10 bg-white px-3 py-2 text-xs font-mono text-gray-900 outline-none focus:ring-2 focus:ring-black/10"
