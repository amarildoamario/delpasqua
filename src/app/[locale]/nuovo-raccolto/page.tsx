...
async function NuovoRaccoltoPage({ params }: { params: Promise<{ locale: string }> }) {
...
export default async function NuovoRaccoltoPageWrapper(props: any) {
  const { locale } = await props.params;
  setRequestLocale(locale);
  return <NuovoRaccoltoPage {...props} />;
}
