  ...
  return (
    <section id={id} className="scroll-mt-24">
      <div className="flex items-start gap-3">
        <div className="mt-2 h-2 w-2 shrink-0 rounded-full bg-zinc-900 dark:bg-zinc-100" />
    ...
    <div className="min-h-screen bg-white text-zinc-900 dark:bg-black dark:text-white">
      <main className="mx-auto max-w-5xl px-4 py-10 md:py-14">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 md:p-8">
          ...
          <div className="mt-6 rounded-xl border border-zinc-200 bg-zinc-50 p-4 text-sm text-zinc-700 dark:border-zinc-800 dark:bg-zinc-900/40 dark:text-zinc-200/90">
            <p className="font-medium text-zinc-900 dark:text-zinc-100">Nota rapida</p>
            <p className="mt-1">
              ...
              <nav className="mt-3 space-y-1">
                {sections.map((s) => (
                  <a
                    key={s.id}
                    href={`#${s.id}`}
                    className="block rounded-lg px-3 py-2 text-sm text-zinc-700 hover:bg-zinc-100 dark:text-zinc-200/90 dark:hover:bg-zinc-900/60"
                  >
                    {s.title}
                  </a>
                ))}
