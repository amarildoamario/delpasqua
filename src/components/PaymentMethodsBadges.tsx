...
export default function PaymentMethodsBadges({ className = "" }: { className?: string }) {
  return (
    <div className={className}>
      <p className="text-center text-[10px] uppercase tracking-widest text-neutral-400 mb-2.5">
        Pagamenti sicuri
      </p>
      ...
      <div className="flex flex-wrap items-center justify-center gap-2.5">
        {/* Apple Pay */}
        <div
          className="flex px-3 h-8 items-center justify-center rounded-md border border-neutral-200 bg-white shadow-sm hover:border-neutral-300 transition-colors"
          title="Apple Pay"
        >
